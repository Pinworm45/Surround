...
void USrInput::UpdateDetection(float DeltaTime)
{
	UpdateGameKeys(DeltaTime);
	ProcessKeyStates(DeltaTime);
}

void USrInput::ProcessKeyStates(float DeltaTime)
{
...
void USrInput::UpdateGameKeys(float DeltaTime)
{
	ASrPlayerController* MyController = CastChecked<ASrPlayerController>(GetOuter());
...
void USrInput::DetectOnePointActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition, FVector2D& AnchorPosition, float& DownTime)
{
...
void USrInput::DetectTwoPointsActions(bool bCurrentState, bool bPrevState, float DeltaTime, const FVector2D& CurrentPosition1, const FVector2D& CurrentPosition2)
{
...
FVector2D USrInput::GetTouchAnchor(int32 i) const
{
